...
import time
from functiontest import dayBr, hour, getDados
from flask_sqlalchemy import SQLAlchemy
from models import db,Leitura, User, session
...
def index(): 
    ...
    return render_template("index.html",constantes=constantes, User = User, user_id = session.get('user'))
